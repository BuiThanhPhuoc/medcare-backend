...
const labTechAdminCtrl = require('../controllers/adminLabTechnicianController');
...
const adminAppointmentCtrl = require('../controllers/adminAppointmentController');
...
// ========================================================
// 🧪 QUẢN LÝ KỸ THUẬT VIÊN XÉT NGHIỆM (CRUD)
// ========================================================
router.get('/lab-technicians', labTechAdminCtrl.getAllLabTechnicians);
router.get('/lab-technicians/:id', labTechAdminCtrl.getLabTechnicianById);
router.post('/lab-technicians', upload.single('avatar'), labTechAdminCtrl.createLabTechnician);
router.put('/lab-technicians/:id', upload.single('avatar'), labTechAdminCtrl.updateLabTechnician);
router.delete('/lab-technicians/:id', labTechAdminCtrl.deleteLabTechnician);
...
// ========================================================
// 📋 QUẢN LÝ LỊCH KHÁM (CMS)
// ========================================================
router.get('/appointments', adminAppointmentCtrl.getAllAppointments);
router.get('/appointments/stats', adminAppointmentCtrl.getAppointmentStatistics);
router.put('/appointments/:id/status', adminAppointmentCtrl.updateAppointmentStatus);
router.put('/appointments/bulk-status', adminAppointmentCtrl.bulkUpdateAppointmentStatus);
router.delete('/appointments/:id', adminAppointmentCtrl.deleteAppointment);
